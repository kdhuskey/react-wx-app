...
function WxCard({ text }) {
  ...
  const currentDayOfMonth = currentDate.toLocaleString(`en-us`, {day: '2-digit'})
  ...
  return (
    <Card className="h-100 wx-card">
      <Container>

        <Card.Title>{currentDay} {currentMonth} {currentDayOfMonth} {isHourly? currentTime: ''}</Card.Title>
